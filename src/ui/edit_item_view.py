...
class EditItemView:
    ...
    def _initialize(self):
        ...
        date_button.grid(row=3, column=2, sticky=constants.N)
        clear_date_button.grid(row=3, column=2, sticky=constants.S)
        mon_check.grid(row=3, column=3)
